        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a target="iframe_context" href="/admin/showUserById?id=${superUser.id}">基本资料</a></dd>
        ...
        <div class="layui-side-scroll" id="left1">
            ...
            <ul id="left2" class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="layui-icon" target="iframe_context" href="javascript:;" style="color:#9FC105">&#xe770;&nbsp;&nbsp;顾客管理</a>
                    <dl class="layui-nav-child">
                        <!--a标签中写ifream的name 则点击超链接 就会在指定name的ifream中显示-->
                        <dd><a target="iframe_context"  href="/customer/unionShowInfo">查询顾客</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="layui-icon" href="javascript:;" style="color:#9FC105">&#xe621;&nbsp;&nbsp;分类管理</a>
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="/bigClass/showInfo">大分类管理</a></dd>
                        <dd><a target="iframe_context" href="/smallClass/showInfo">小分类管理</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="layui-icon" href="javascript:;" style="color:#9FC105">&#xe621;&nbsp;&nbsp;商品管理</a>
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="/goods/getGoodsList">查询商品</a></dd>
                        <dd><a target="iframe_context" href="/goods/localAddGoods">添加商品</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
